//! This crate has for goal to enable filtering in the bevy's [`Query`](bevy_ecs::system::Query) by value for a given [`Component`].
//! It is usefull when the component has the following form:
//! ```rust
...
/// # use bevy_mod_value_filter::Check;
/// # use bevy_mod_value_filter::Is;
/// # use bevy_mod_value_filter::IsTrue;
///
/// #[derive(Component)]
/// struct Poisoned(bool);
///
/// impl core::ops::Deref for Poisoned {
///     type Target = bool;
///
