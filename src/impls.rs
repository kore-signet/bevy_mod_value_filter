...
//     // ) {
//     //     match T::STORAGE_TYPE {
//     //         StorageType::Table => fetch.entity_table_rows = Some(archetype.ent),
//     //         StorageType::SparseSet => todo!(),
//     //     }
//     // }

//     unsafe fn set_table<'w>(fetch: &mut Self::Fetch<'w>, state: &Self::State, table: &'w Table) {
//         let column: Column = table.get_column(state.component_id).unwrap().into();
//     }
...
// impl<T: Component, Pred: Predicate<T>> ReadOnlyWorldQuery for Check<T, Pred> {}
...
// impl<'w, T: Component, Pred: Predicate<T>> Fetch<'w> for CheckFetch<'w, T, Pred> {
//     type Item = bool;
//     type State = CheckState<T>;
